...
- `github.com/gurufinresearch/x402/go` - Core x402
- `github.com/gurufinresearch/x402/go/http` - HTTP integration
- `github.com/gurufinresearch/x402/go/http/gin` - Gin middleware
- `github.com/gurufinresearch/x402/go/mechanisms/evm` - EVM server
- `github.com/gurufinresearch/x402/go/mechanisms/svm` - SVM server
- `github.com/gurufinresearch/x402/go/extensions/bazaar` - Discovery extension
