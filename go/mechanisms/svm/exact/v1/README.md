...
import (
    ...
    "github.com/gurufinresearch/x402/go/mechanisms/solana/v1"
)
...
**Before (V1)**:
```go
import "github.com/gurufinresearch/x402/go/mechanisms/solana/v1"
...
**After (V2)**:
```go
import "github.com/gurufinresearch/x402/go/mechanisms/solana"
